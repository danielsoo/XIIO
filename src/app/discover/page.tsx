...
export default function DiscoverPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      if (tab === "open") params.set("openOnly", "1");
      if (tab === "following") params.set("followingOnly", "1");
        ...
        {people.map((p) => (
          <li key={p.uid}>
            <Link
              ...
              className="block h-full rounded-xl border border-white/10 bg-xiio-surface p-4 hover:border-xiio-accent/40 transition"
            >
